...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-0 pe-5">
        <a href="{{ url('/pegawai') }}" class="navbar-brand ps-5 me-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="{{ url('/pendaftaran_pekerja') }}" class="nav-item nav-link">Pendaftaran</a>
                <a href="{{ url('/orderan_anda') }}" class="nav-item nav-link">Orderan Anda</a>
                    </div>
                </div>
            </div>
